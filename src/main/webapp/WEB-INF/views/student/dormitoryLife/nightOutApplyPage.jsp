...
<style>
   ...
   table{
	...
	.nav-tabs {
	    ...
	    --bs-nav-tabs-link-active-bg: #fdefc3;
   }
   ...
   <div class="page-content p-4" id="content">
		...
		<div class="row py-1"></div>
   		...
   		<div class="row py-3"></div>
	 		<div class="row shadow py-3 mx-3" style="background: #fff1c669; border-radius:10px;" >
 		...
 		<div class="row py-3"></div>
			<div class="row shadow py-3 mx-3" style="background: #fff1c669; border-radius:10px;" id="nightOutApplyContent">
				<div class="col">
					<div class="row mb-1">
