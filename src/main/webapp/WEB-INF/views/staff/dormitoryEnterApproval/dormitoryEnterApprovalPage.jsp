					...
					<div class="col">
						...
						<div>
								...
								<div class="col">
									<div class="row">
										<div class="col">
											...
											<select id="entInfoSelectTag" name="ENT_NO" class="form-select" style="display: inline-block; width: 10vw; font-size: 0.7rem; height: 2.5vh; padding: 0; padding-left: 0.5vw">
											</select>
										</div>
										<div class="col">
									...
									<div class="row" style="margin-top: 2px">
										<div class="col">
											...
											<select id="genderSelectTag" name="STUD_GENDER" class="form-select" style="display: inline-block; width: 10vw; font-size: 0.7rem; height: 2.5vh; padding: 0; padding-left: 0.5vw">
							...
							<div id='showApplListAria'style="height: 48vh;">
								<div id='loadingImage' style="height: 45vh; position: absolute; margin-left: 39%; margin-top: 5%">
								</div>
